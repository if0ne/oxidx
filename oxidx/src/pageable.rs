use windows::{core::Interface, Win32::Graphics::Direct3D12::ID3D12Pageable};

use crate::{
    create_type, descriptor_heap::DescriptorHeap, heap::Heap, impl_interface, impl_up_down_cast,
    query_heap::QueryHeap, resources::Resource,
};
